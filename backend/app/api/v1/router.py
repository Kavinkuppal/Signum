...
from app.api.v1 import products, suppliers, auth, seed, scrape, projects, ai, custom_suppliers
...
router.include_router(custom_suppliers.router, prefix="/custom-suppliers", tags=["custom-suppliers"])
